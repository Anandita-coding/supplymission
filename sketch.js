...
var options = {
	...
	side1 = new Ground(585,570,20,134)
	side2 = new Ground(785,570,20,134)
	bottom = new Ground(685,585,222,20)
	ground = new Ground(width/2,height,1365,20);
